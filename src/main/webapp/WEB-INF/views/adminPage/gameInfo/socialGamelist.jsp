...
<div id="modalout"></div>
    <div id="modal">
        ...
        <input type="hidden" name="select" value="gameAdmin">
            <ul id="flist">
                <li><p>경기장코드 : </p> <input type="text" name="fieldCode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="infieldCode" class="inbox" autocomplete='off'></li>
                ...
                <li><p>경기날짜 : </p> <input type="text" name="gameDay" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="txtDate" value="" autocomplete='off'></li>
